...
// locationRepository is a concrete repository that implements repository.
type locationRepository struct {
	*repository
}

// NewLocationRepository is constructor for locationRepository.
func NewLocationRepository(logger logger.Logger, conf *config.Config, db *gorm.DB) Repository {
	...
	return &locationRepository{&repository{db: db}}
}
